      ...
      <div className={styles.about}>
        <div>
          <Animate>
            ...
            <p className={styles.aboutText}>
              Outside of work, I love to follow a healthy and fitness oriented lifestyle. I train multiple days a week and aspire to have a  perfectly healthy lifestyle (I try my best :)). A secret I would like to tell you, I make great coffee.
            </p>
